...
void SweetPepperInstance::initGL (int32_t result) {
    ...
    glViewport  (0, 0, mPluginSize.width(), mPluginSize.height());
...
void SweetPepperInstance::initFFmpeg () {
    ...
    const char *videoFilePath = "test.mp4";
...
void SweetPepperInstance::paintYuv (int32_t result) {
    ...
    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, width, height,
                    GL_LUMINANCE, GL_UNSIGNED_BYTE, mpFrame->data[0]);
    ...
    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, width, height,
                    GL_LUMINANCE, GL_UNSIGNED_BYTE, mpFrame->data[1]);
    ...
    glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, width, height,
                    GL_LUMINANCE, GL_UNSIGNED_BYTE, mpFrame->data[2]);
